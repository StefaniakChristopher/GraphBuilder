    ...
    <>
      ...
      <main className="flex flex-col justify-center items-center h-[1000px]">
        ...
        <h3 className="text-5xl [color:var(--font-secondary)] mb-10">
          <span className="[color:var(--backup-color)]">Visualize</span> data in{" "}
          <span className="[color:var(--backup-color)] underline">seconds</span>
        </h3>
        <Link to="/creategraph">
      ...
      <section className="mb-20">
        ...
        <div className="flex justify-evenly">
          <div className=" rounded-full [background:var(--bg-secondary)] size-64 flex justify-center items-center flex-col">
            <h3 className="[color:var(--font-primary)] text-4xl font-bold mb-4">
              Graph Types
            </h3>
            <p className="text-center [color:var(--font-secondary)] font-semibold">
